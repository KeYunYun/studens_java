...
<body>
	...
	<ul class="yiji">
		<li><a href="#">菜单栏</a></li>
		<li><a href="#" class="inactive">&nbsp;&nbsp;&nbsp;&nbsp;人员管理</a>
			<ul style="display: none">
				<li><a href="../ShowManagerInfo?option=list" target="content">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;显示管理人员</a><br>
				</li> 
				<li><a href="../manager/addinfo.jsp" target="content">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;添加管理人员</a><br>
				</li>
			</ul>
		</li>
		<li><a href="#" class="inactive">&nbsp;&nbsp;&nbsp;&nbsp;教室信息管理</a>
			<ul style="display: none">
				<li><a href="../ClassRoomManager?option=list" target="content">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;显示教室信息</a><br>
				</li> 
				<li>	<a href="../classroomManage/addClassRoom.jsp" target="content">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;添加教室信息</a><br>
				</li>
			</ul>
		</li>
