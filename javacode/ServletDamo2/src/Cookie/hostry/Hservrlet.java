...
public class Hservrlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//获得cookie
		Cookie history= CookieUtiles.getCookieByName(request, "history");
		if(history!=null){
		...
		response.sendRedirect("/ServletDamo2/patten/out.jsp");
	}
